...
class TextAggregator:
    ...
    def aggregate_text_from_urls(self, urls: List[Dict[str, Any]], output_file: str = "combined_text.txt") -> Dict[str, Any]:
        """
        ...
        with open(output_path, 'w', encoding='utf-8') as f:
            ...
            for i, url_info in enumerate(urls, 1):
                ...
                try:
                    ...
                    # Extract text
                    result = self.text_extractor.extract_text_from_html(html, url_info['url'])
    ...
    def aggregate_programs(self, programs: List[str], output_file: str = "combined_text.txt") -> Dict[str, Any]:
        """
...
def aggregate_text_from_programs(programs: List[str], output_file: str = "combined_text.txt", output_dir: str = "outputs") -> Dict[str, Any]:
    """
