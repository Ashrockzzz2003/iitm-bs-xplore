...
class HierarchicalTextAggregator:
    ...
    def aggregate_text_from_urls(self, urls: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for key, buffer_data in content_buffers.items():
            ...
            with open(file_path, 'w', encoding='utf-8') as f:
                # Write header
                f.write("=" * 80 + "\n")
                f.write(f"IITM BS Xplore - {buffer_data['program']} Program - {buffer_data['level'].title()} Level\n")
    ...
    def _create_content_entry(self, url_info: Dict[str, Any], result: Dict[str, Any]) -> str:
        """
...
def aggregate_text_hierarchically(programs: List[str], output_dir: str = "outputs") -> Dict[str, Any]:
    """
