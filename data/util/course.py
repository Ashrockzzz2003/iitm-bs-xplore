...
class CoursePageSchema(BaseModel):
    ...
    learning_outcomes: List[str] = Field(
        default_factory=list, description="List of learning outcomes for the course"
    )
    ...
    assessment_structure: Optional[str] = Field(
        None, description="Textual description of how the course is graded"
    )
    resources_and_books: List[Book] = Field(
        default_factory=list, description="List of books and resources for the course"
    )
...
def save_course_to_db(
    cursor, course_data: CoursePageSchema, final_level: str, source_url: str
):
    """
