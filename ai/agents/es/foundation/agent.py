...
root_agent = Agent(
    model=GEMINI_MODEL,
    name="IITM_BS__ElectronicSystems__FoundationLevelAgent",
    description="A helpful assistant for user questions about the foundational level of IITM BS Electronic Systems Program.",
