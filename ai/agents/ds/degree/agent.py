...
- smart_query(query, program="ds", level="degree", n_results=5): This is the primary tool for querying the chunked ChromaDB data. It intelligently searches across relevant collections for the DS degree level.
- query_by_program_and_level("ds", "degree", query, n_results=5): Alternative tool for specific program/level queries.
