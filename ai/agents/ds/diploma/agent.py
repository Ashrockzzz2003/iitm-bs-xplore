...
- smart_query(query, program="ds", level="diploma", n_results=5): This is the primary tool for querying the chunked ChromaDB data. It intelligently searches across relevant collections for the DS diploma level.
- query_by_program_and_level("ds", "diploma", query, n_results=5): Alternative tool for specific program/level queries.
...
Query strategy:
- Use smart_query("ds", "diploma", <keywords>) as your primary tool
...
- The tool will automatically search across all relevant DS diploma level collections
